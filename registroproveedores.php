    ...
    <div class="container-fluid container-custom">
        <div class="row w-100">
            <div class="col-md-4">
                <form>
                    <div class="mb-2">
                        <label for="idProducto" class="form-label">ID Proveedores:</label>
                        <input type="text" class="form-control" id="idProducto">
                    </div>
                    <div class="mb-2">
                        <label for="idProveedor" class="form-label">ID Productos:</label>
                    ...
                    <div class="mb-2">
                        <label for="marca" class="form-label">Nombre Proveedor:</label>
                        <input type="text" class="form-control" id="marca">
                    </div>
                    <div class="mb-2">
                        <label for="precioUnidad" class="form-label">Telefono:</label>
